...
- **Full skill list**: every installed skill (name, description, source, path, state) with **search** and **pagination** (configurable page size: 10/20/50/100, or all on one page) — no more paging through the `/` picker.
